import sys
# Checking for version of python install for full support
...
if len(sys.argv) > 1 and sys.argv[1] == "-cli":
    ...
    isCLI = False
# ||^^^^since GUI was introduced in later version of python 2 and later so to be backward compatiblity we have mention the CLI Mode for chatiing

if version == 2:
    from Tkinter import *
    from tkFileDialog import asksaveasfilename
#for python3 the package name tkFileDialog change to tkinter.filedialog  main file needed is asksaveasfilename
if version == 3:
    from tkinter import *
    from tkinter.filedialog import asksaveasfilename
# additional packages for application support
# for multithreading purposes
import threading

#for socket Programming functionality
import socket

#for generation random
import random

#for math functionality
import math
...
# ord returns the unicode param for eg: ord('a') = 97,or the value of the byte when the argument is an 8-bit string so check is performed below unicode ex:u'\u2020'
def binWord(word):
...
def x_encode(string, number):
    ...
    #Convert an integer number to a binary string bin().
...
def processFlag(number, conn=None):
    ...
    if t == 2:  # username change Feature code
...
def client_options_window(master):
    ...
    # protocol to handle closing event
...
#------------------------------------------------------------------------------
#Usename Feature in list options
#------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------
#Error window for exception handling
#------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------
#Contacts window GUI coding and functionality code
#------------------------------------------------------------------------------
